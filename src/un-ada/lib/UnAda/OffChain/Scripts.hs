...
import           Convex.PlutusLedger         (toMaryAssetName, transAssetName, transScriptHash,
                                              transPolicyId)
...
mintingPolicyScript =
  compiledCodeToScript (mintingPolicyCompiled $ transScriptHash $ C.hashScript $ C.PlutusScript C.PlutusScriptV2 validatorScript)
