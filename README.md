...
|Name|Version|
|--|--|
|`cardano-node`|[8.12.0](https://chap.intersectmbo.org/package/cardano-node-8.12.0/)|
|`cardano-api`|[8.48.0.1](https://chap.intersectmbo.org/package/cardano-api-8.48.0.1/)|
|`ghc`|9.6.4|
|`cabal`|3.10.1.0|
