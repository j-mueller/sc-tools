...
|Name|Version|
|--|--|
|`cardano-node`|[10.1.3](https://github.com/IntersectMBO/cardano-node/releases/tag/10.1.3)|
|`cardano-api`|[10.4.0.0](https://chap.intersectmbo.org/package/cardano-api-10.4.0.0/)|
|`ghc`|9.6.6|
|`cabal`|3.10.3.0|
